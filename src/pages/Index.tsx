...
import { Book, Activity, ArrowRight, GraduationCap, Star, Users, BookOpen, Award } from 'lucide-react';
                ...
                <div className="aspect-square relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                    <div>
                      ...
                      <p className="text-white/80 text-sm">{topic.courseCount} courses</p>
                    </div>
                  </div>
                </div>
              </Link>
